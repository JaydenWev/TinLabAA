...
\newpage
\section{Inleiding}
Voor het vak Advanced Algorithms wordt een sluis gemodelleerd. Wij hebben gekozen voor een shutsluis. Mede omdat we bij deze soort sluis bij schippers kunnen aankloppen voor vragen en informatie. Voor het modelleren van de sluis is onderzoek gedaan om een aantal requirements op te kunnen stellen. Met name de veiligheid is hierbij van belang.
\\\\
...
\begin{itemize}
\item Als deur "A" \& "B" mogen niet tegelijk open zijn.
\item Ten alle tijden moet het water niveau worden bij gehouden.
\item (Als de temperatuur on 0$^{\circ}$C komt moeten de antivries maatregelen geactiveerd worden.)
\end{itemize}
